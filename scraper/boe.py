...
_KW_RAW: List[Tuple[str, str, bool]] = [
    ...
    ("hidrógeno renovable",                             "hidrogeno renovable",                             False),
    ("hidrógeno bajo en carbono",                       "hidrogeno bajo en carbono",                       False),
    ("hidrógeno",                                       "hidrogeno",                                       False),
    ("electrolizador",                                  "electrolizador",                                  False),
    ("pila de combustible",                             "pila de combustible",                             False),
    ("combustibles renovables de origen no biológico",  "combustibles renovables de origen no biologico",  False),
    ("RFNBO",                                           "rfnbo",                                           True ),
    ("amoníaco verde",                                  "amoniaco verde",                                  False),
    ("metanol renovable",                               "metanol renovable",                               False),
    ("vector energético",                               "vector energetico",                               False),
    ("combustible sintético",                           "combustible sintetico",                           False),
    ...
    ("liquidación del sector eléctrico",                "liquidacion del sector electrico",                False),
    ("liquidaciones del sector eléctrico",              "liquidaciones del sector electrico",              False),
    ("liquidación de los costes",                       "liquidacion de los costes",                       False),
    ("peajes y cargos",                                 "peajes y cargos",                                 False),
    ("peajes de transporte",                            "peajes de transporte",                            False),
    ("peajes de distribución",                          "peajes de distribucion",                          False),
    ("cargos del sistema eléctrico",                    "cargos del sistema electrico",                    False),
    ("cargos del sistema",                              "cargos del sistema",                              False),
    ("suplemento territorial",                          "suplemento territorial",                          False),
    ("suplementos territoriales",                       "suplementos territoriales",                       False),
    ...
    ("gasoducto",                                       "gasoducto",                                       False),
    ("biometano",                                       "biometano",                                       False),
    ("GNL",                                             "gnl",                                             True ),
    ("regasificación",                                  "regasificacion",                                  False),
    ("metanización",                                    "metanizacion",                                    False),
    ("almacenamiento de gas",                           "almacenamiento de gas",                           False),
    ("red de gas",                                      "red de gas",                                      False),
    ("instalación de gas",                              "instalacion de gas",                              False),
    ("Enagás",                                          "enagas",                                          False),
    ("Redexis",                                         "redexis",                                         False),
    ("Nedgia",                                          "nedgia",                                          False),
...
_EXCLUDED_SUBSECTIONS = re.compile(r"\brtve\b|convenio|entidades de seguros|actividad aseguradora", re.IGNORECASE)
_EXCLUDED_ORGANISMS   = re.compile(r"\buniversidad|telecomunicaci|\bAENA\b|aeropuertos espa[ñn]oles", re.IGNORECASE)
_EXCLUDED_TITLES = [
